...
@Component({
  selector: 'payment-form-dynamic',
  templateUrl: './payment-form-dynamic.component.html',
  styleUrls: ['./payment-form-dynamic.component.scss']
})
export class PaymentFormDynamicComponent extends FormDynamicComponent {
  ...
  uploadInvoices(invoices: FormData) {
    return this.paymentService.uploadInvoices(invoices);
  }
